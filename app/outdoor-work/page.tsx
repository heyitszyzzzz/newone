          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-1 gap-4">
                <Image
                  src="/images/gallery-composite-decking.jpg"
                  alt="Professional composite decking installation"
                  width={400}
                  height={300}
                  className="rounded-lg shadow-lg"
                />
                <Image
                  src="/images/gallery-wooden-fence-installation.jpg"
                ...
                />
                <Image
                  src="/images/gallery-wooden-garden-gate.jpg"
                  alt="Custom wooden garden gate"
                  width={400}
                  height={300}
                  className="rounded-lg shadow-lg"
                />
